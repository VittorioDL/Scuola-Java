public class Lista
{
    ...
    {
        if(testa.getSuccessivo() == null && testa != null) testa = testa.getSuccessivo();
        else if(!isEmpty())
        {
            Nodo n = testa;
    ...
    public void concatenaLista(Lista l)
    {
        getCoda().setSuccessivo(l.getTesta());
    }
    
    public void concatenaCoda(Coda c)
    {
        getCoda().setSuccessivo(c.getTesta());
    }
